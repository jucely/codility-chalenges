...
public class BinaryGap1 {
	 ...
	 * 3 - For each sequence of '0', verify if it is between '1' and it's the largest sequence of '0' found.
	 * 
    ...
    public int solution(int N) {
        ...
        for(String str : strIntervalo){
            ...
            maiorSequencia = binary.contains(intervalo) && str.length() > maiorSequencia ?
                str.length() : maiorSequencia;
        }
